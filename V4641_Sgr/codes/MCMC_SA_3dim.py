...
[lgB0,rate0,lgK0] = [-0.60, 0.040961672771081724,52.22]
initial = [lgB0,rate0,lgK0]
...
#-------------------------------------------------------------------------------------------------------
    new_folder = "SA_3dim_model_xi=1_%s_lgrho=%s_pc_limited_DIFFUSION_MODIFIED_%s_GalacticExtinction_q=%s_widerange"%(R,lgrho,num,q)
...
# median values
    ...
    np.savetxt(path1+'/'+new_folder+'/chi2_lgB0=%s_rate=%s_lgK=%s_n=%s_weighted.txt'%(initial[0],initial[1],initial[2],n_steps),-2*proba_list)
