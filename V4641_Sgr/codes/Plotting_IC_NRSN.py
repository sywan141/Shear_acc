...
# 左上
file1 = np.loadtxt(dir_dat1+'IC_5.0pc_spec_nrsn.txt')
...
plt.show()
plt.savefig(dir_tar+ 'IC_all_HESS_nrsn.pdf',format="pdf", dpi=300, bbox_inches="tight")
plt.savefig(dir_tar+ 'IC_all_HESS_nrsn.png')