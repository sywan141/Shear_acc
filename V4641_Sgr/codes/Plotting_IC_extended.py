...
# 左上
file1 = np.loadtxt(dir_dat1+'IC_5.0pc_spec_extended.txt')
...
#右上
file2 = np.loadtxt(dir_dat1+'IC_1.0pc_spec_extended.txt')
...
#左下
file3 = np.loadtxt(dir_dat1+'IC_0.5pc_spec_extended.txt')
...
#右下
file4 = np.loadtxt(dir_dat1+'IC_0.1pc_spec_extended.txt')
...
plt.show()
plt.savefig(dir_tar+ 'IC_all_HESS_extended.pdf',format="pdf", dpi=300, bbox_inches="tight")
plt.savefig(dir_tar+ 'IC_all_HESS_extended.png')